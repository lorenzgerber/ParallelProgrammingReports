...
\item if sending one message takes $10^{-3}$ seconds , the communication with 1000 cores will take: $10^{9}(1000-1) \times 10^{-3} = 9.99\times10^{14} s$, or several trillion years...
\end{enumerate}
